...
export const fieldSchemas = {
  ...
  sandbox_prefix: { label: 'Destination Prefix', type: 'text', placeholder: 'Optional destination folder prefix', helper: 'Optional prefix added to generated destination paths.' },
  ...
  cloud_provider: { label: 'Cloud Provider', type: 'text', placeholder: 'Google Cloud Storage' },
  cloud_bucket: { label: 'Cloud Bucket', type: 'text', placeholder: 'Bucket name', helper: 'Placeholder for future cloud source input.' },
  cloud_prefix: { label: 'Cloud Prefix', type: 'text', placeholder: 'Optional folder/prefix' },
  cloud_credentials_ref: { label: 'Cloud Credentials Reference', type: 'text', placeholder: 'Credential reference' },
}
